...
| 6 | 2026-04-16 | City flag + name prominent in loading and error screens (NPS 5.6) | Loading and error screens now show city flag emoji (40px) and city name (20px bold) above the spinner/message, making it immediately clear which city is selected even when weather data fails. Blob cache warmed post-deploy for Amsterdam. |
